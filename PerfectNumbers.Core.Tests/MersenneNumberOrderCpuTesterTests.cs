...
public class MersenneNumberOrderCpuTesterTests
{
    ...
    {
        var tester = new MersenneNumberOrderCpuTester(type);
    ...
    private static void RunCase(MersenneNumberOrderCpuTester tester, ulong exponent, ulong maxK, bool expectedPrime)
    {
        bool isPrime = true;
