        ...
        ArrayView1D<ulong, Stride1D.Dense> groupBDivisorsEnding9)
    {
        ...
        switch (tableKind)
        {
            case HeuristicGpuDivisorTableKind.GroupA:
                divisors = groupADivisors;
                break;
            case HeuristicGpuDivisorTableKind.GroupBEnding1:
                divisors = groupBDivisorsEnding1;
                break;
            case HeuristicGpuDivisorTableKind.GroupBEnding7:
                divisors = groupBDivisorsEnding7;
                break;
            case HeuristicGpuDivisorTableKind.GroupBEnding9:
                divisors = groupBDivisorsEnding9;
                break;
            case HeuristicGpuDivisorTableKind.Combined:
                switch (nMod10)
                {
                    case 1:
                        divisors = combinedDivisorsEnding1;
                        break;
                    case 3:
                        divisors = combinedDivisorsEnding3;
                        break;
                    case 7:
                        divisors = combinedDivisorsEnding7;
                        break;
                    case 9:
                        divisors = combinedDivisorsEnding9;
                        break;
                    default:
                        return;
                }
        ...
        ulong limit = maxDivisorSquare / divisor;
        if (divisor > limit)
        {
            return;
        }
