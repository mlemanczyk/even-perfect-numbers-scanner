    ...
    public void Scan(ulong exponent, UInt128 twoP, bool lastIsSeven, UInt128 maxK, ref bool isPrime)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                // TODO: Replace the direct UInt128 multiply/add updates below with the residue-cycle stepping helper so that q advances
                // reuse cached cycle increments rather than recomputing twoP multiples on every iteration.
