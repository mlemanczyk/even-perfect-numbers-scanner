		...
		while (k < maxK && (localIsPrime = Volatile.Read(ref isPrime)))
		{
			...
			// lane 0
                                ...
                                (((allowMask >> (int)r10_0) & 1) != 0 && (r8_0 == 1UL || r8_0 == 7UL) && r3_0 != 0UL && r5_0 != 0UL))
                        {
                                ...
                                if (localIsPrime && tracker.MergeOrAppendCpu(exponent, q, out isDivider) && isDivider &&
			...
			if (lanes >= 2 &&
				...
				localIsPrime)
			{
				if (localIsPrime && tracker.MergeOrAppendCpu(exponent, qIncremental, out isDivider) && isDivider &&
